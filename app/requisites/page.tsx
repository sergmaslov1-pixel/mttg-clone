...
const rows = [
  ...
  { label: 'Организационно-правовая форма', value: 'Общество с ограниченной ответственностью' },
  { label: 'ИНН', value: '7701884760' },
  { label: 'КПП', value: '770901001' },
  { label: 'ОГРН / дата регистрации', value: '1107746583460 / 23.07.2010' },
  { label: 'Регистрирующий орган', value: 'Межрайонная инспекция Федеральной налоговой службы №46 по г. Москве' },
  { label: 'Основной вид деятельности (ОКВЭД)', value: 'Деятельность по управлению финансово-промышленными группами (70.10.1)' },
  { label: 'ОКПО', value: '66920392' },
  { label: 'ОКОПФ / ОКАТО / ОКФС / ОКОГУ', value: '12300 / 45286580000 / 16 / 4210014' },
  { label: 'Юридический адрес', value: '109147, г. Москва, ул. Марксистская, д. 22, стр. 1, под. 2, эт. 5, комн. 17' },
  { label: 'Почтовый адрес', value: '109147, г. Москва, ул. Марксистская, д. 22, стр. 1, под. 2, эт. 5, комн. 17' },
