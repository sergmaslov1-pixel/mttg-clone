...
const team: Person[] = [
  {
    ...
    role: 'Генеральный директор «МТТ Групп»',
    ...
    bio: [
      ...
      'С 2010 г. по 2021 г. — генеральный директор ОАО «МТТ». С ноября 2011 года — генеральный директор «МТТ Групп». С декабря 2018 г. — член Совета директоров «МТТ Групп».',
    ],
  },
  {
    name: 'Денис Широкий',
    role: 'Член Совета директоров «МТТ Групп»',
    ...
    bio: [
      ...
      'С июля 2021 года — член Совета директоров «МТТ Групп».',
    ],
  },
  {
    name: 'Артур Акопьян',
    role: 'Член и председатель Совета директоров «МТТ Групп»',
    photo: null,
    photoW: 0,
    photoH: 0,
    bio: [
      ...
      'В сентябре 2013 года был избран председателем совета директоров ООО «МТТ Групп», в мае 2015 г. покинул этот пост. В июле 2021 г. вновь избран председателем Совета директоров «МТТ Групп».',
    ],
  },
];
